"""
Django settings for django_ginicorn project.
...
ROOT_URLCONF = 'django_ginicorn.urls'
...
WSGI_APPLICATION = 'django_ginicorn.wsgi.application'
...
LOGGING = {
    ...
    "formatters": {
        "verbose": {
            "format": "{levelname} {asctime} {module} {process:d} {thread:d} {pathname}:{lineno:d} {message}",
            "style": "{",
        },
    },
    "handlers": {
